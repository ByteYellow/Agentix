"""Tests for `agentix.provider._plugin.Registry[T]`.
...
from agentix.provider._plugin import PluginConflictError, Registry
...
def _src(name, version):
    from agentix.provider._plugin import PluginSource
