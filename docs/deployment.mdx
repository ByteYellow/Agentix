---
title: Deployments
description: Start bundles as sandboxes and hand RuntimeClient a runtime URL.
---

A deployment backend answers one question: where should this bundle run?
...
```python
from agentix import load_deployment
